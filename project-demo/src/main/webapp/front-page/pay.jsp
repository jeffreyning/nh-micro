...
function payNow(){
	var investAmount=$('#J_balance').val();
...
<header>
    ...
    <div class="wrapper con">
        ...
        <div class="pay-con">
            ...
            <div data-wrap="layout" class="zh-pay grey-shadow" data-checked="false">
                <span data-item="col-5" class="fl">账户余额：<b class="J_balance" id="J_balanceYShow"></b><b class="J_balance none" id="J_balanceY"></b><i>元</i></span>
                <span data-item="col-5" class="fr">支付<em></em>：<b class="J_balance" id="J_balance">${investInfo.invest_amount}</b>元</span>
            </div>
            <div class="pay-title special clearfix">
                ...
                <span class="pay-show J_pay-show">支付:<b class="J_kuaijieMoney">0.00</b>元</span>
            ...
            <div class="pay-title clearfix">
                ...
                <span class="pay-show">支付:<b id="J_wangyinMoney">0.00</b> 元</span>
            </div>
    ...
    <div class="tipShow">
        <div class="wrapper">
            <span class="paymentTotle">应付总额：<b id="J_investAmount"></b> 元</span>
