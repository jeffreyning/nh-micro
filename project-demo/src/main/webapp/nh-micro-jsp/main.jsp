...
<body class="easyui-layout">
	<div region="north" href="<%=path%>/nh-micro-jsp/layout/north.jsp" split="false" border="false" style="overflow: hidden; height: 30px;background: 	#D1E9E9">
    </div>
	<div region="west" href="<%=path%>/nh-micro-jsp/layout/west2.jsp" title="导航" split="false" style="width:200px;overflow: hidden;"></div>
	<div region="center" href="<%=path%>/nh-micro-jsp/layout/center.jsp" title="欢迎访问nh-micro系统" style="overflow: hidden;"></div>
    <div region="south" split="false" style="height: 30px; background: #D2E0F2; ">
        <div class="footer">By NH</div>
    </div>
</body>
</html>
