...
<%
	...
	String tableName="nh_micro_dictionary";
		...
		columns:[[
					...
					,
					{
						...
						formatter: function(value, row, index){
							var suburl="<%=path%>/nh-micro-jsp/dictionary-page/listDictItemsInfo.jsp?";
							suburl=suburl+"meta_type="+row.meta_key;

						    return '<a href="'+suburl+'">查看字典项</a>';
						}
					}					
				]],
        toolbar : [ {
