...
<%
	...
	String tableName="nh_micro_dict_items";
	String pageName="listDictItemsInfo";	
	String meta_type=request.getParameter("meta_type");
%>
<html>
<head>
...
$(function(){
	$('#infoList').datagrid({
		...
		url:"<%=path%>/NhEsbServiceServlet?tableName=<%=tableName%>&pageName=<%=pageName%>&cmdName=Groovy&subName=micro_mvc_dict_items&groovySubName=getInfoList4Page&meta_type=<%=meta_type%>",
		columns:[[
					{
						field : 'id',
						title : 'id',
	...
	function addOne(){
		...
		var url="<%=path%>/NhEsbServiceServlet?tableName=<%=tableName%>&pageName=<%=pageName%>&cmdName=Groovy&subName=micro_mvc_dict_items&groovySubName=createInfo&meta_type=<%=meta_type%>";
	...
	function updateOne(){
		var url="<%=path%>/NhEsbServiceServlet?tableName=<%=tableName%>&pageName=<%=pageName%>&cmdName=Groovy&subName=micro_mvc_dict_items&groovySubName=updateInfo&meta_type=<%=meta_type%>";
	...
	function remove(){
		...
		if(sels == ''|| sels==null){
			...
			if(result == true){
				var querydata = $('#searchForm').serializeObject();
				var id = sels.id;
				var url="<%=path%>/NhEsbServiceServlet?tableName=<%=tableName%>&pageName=<%=pageName%>&cmdName=Groovy&subName=micro_mvc_dict_items&groovySubName=delInfo";
				url=url+"&id="+id;
