...
$(function(){
	$('#infoList').datagrid({
		...
		url:"<%=path%>/NhEsbServiceServlet?pageName=<%=pageName%>&cmdName=Groovy&subName=bizflow_creditaudit_list&groovySubName=getBizInfoList4Page4First",
		columns:[[
					{
						field : 'id',
						title : 'id',
					...
					,
					{
						...
						formatter: function(value, row, index){
							var viewpage="<%=path%>/nh-micro-jsp/bizflow-page/creditAudit/creditAuditInfoMain.jsp?sourceFlag=firstApproval&id="+row.id;
							var ret='<a href="'+viewpage+'">信审初审审批</a>';
							return ret;
						}
					}					
				]],
