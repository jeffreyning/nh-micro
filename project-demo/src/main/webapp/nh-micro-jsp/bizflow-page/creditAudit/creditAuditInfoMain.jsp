...
<%
	...
	String firstApprovalOperFlag="view";
	String finalApprovalOperFlag="view";
	if(sourceFlag!=null && "firstApproval".equals(sourceFlag)){
		firstApprovalOperFlag="update";
	}
	if(sourceFlag!=null && "finalApproval".equals(sourceFlag)){
		finalApprovalOperFlag="update";
	}	
%>
<html>
<head>
...
src="<%=path %>/NhEsbServiceServlet?cmdName=Groovy&subName=bizflow_creditaudit_list&groovySubName=viewTaskDataGo&id=<%=id %>&operFlag=<%=formOperFlag %>"
 marginheight="0" id="infoReviewFrame" frameborder="0" style="border:0;width:100%;height:100%;"></iframe>					
					</div>
					<div title="信审初审" >
<iframe marginwidth="0" 
src="<%=path %>/NhEsbServiceServlet?cmdName=Groovy&subName=bizflow_creditaudit_list&groovySubName=viewFirstApprovalGo&id=<%=id %>&operFlag=<%=firstApprovalOperFlag %>"
 marginheight="0" id="infoReviewFrame" frameborder="0" style="border:0;width:100%;height:100%;"></iframe>					
					</div>
					<div title="信审终审" >
<iframe marginwidth="0" 
src="<%=path %>/NhEsbServiceServlet?cmdName=Groovy&subName=bizflow_creditaudit_list&groovySubName=viewFinalApprovalGo&id=<%=id %>&operFlag=<%=finalApprovalOperFlag %>"
 marginheight="0" id="infoReviewFrame" frameborder="0" style="border:0;width:100%;height:100%;"></iframe>					
					</div>					
				</div>
			</li>
