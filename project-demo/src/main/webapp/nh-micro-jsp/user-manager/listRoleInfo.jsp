...
$(function(){
	$('#infoList').datagrid({
		...
		url:"<%=path%>/NhEsbServiceServlet?cmdName=Groovy&subName=nhuser_role&groovySubName=getInfoList4Page",
		columns:[[
					{
						field : 'id',
						title : 'id',
	...
	function addOne(){
		...
		var url="<%=path%>/NhEsbServiceServlet?cmdName=Groovy&subName=nhuser_role&groovySubName=createInfo";
	...
	function updateOne(){
		var url="<%=path%>/NhEsbServiceServlet?cmdName=Groovy&subName=nhuser_role&groovySubName=updateInfo";
	...
	function remove(){
		...
		if(sels == ''|| sels==null){
			...
			if(result == true){
				var querydata = $('#searchForm').serializeObject();
				var id = sels.id;
				var url="<%=path%>/NhEsbServiceServlet?cmdName=Groovy&subName=nhuser_role&groovySubName=delInfo";
				url=url+"&id="+id;
